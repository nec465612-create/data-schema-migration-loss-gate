...
- Current package revision: `fd956a413bff1be16f5773267ec047243864f2d5`
- Package identity: `DSM-LG-POSTDEPLOY-FD956A4`
...
The retained PRE_DEPLOY approval was for package `DSM-LG-PREDEPLOY-A7D5463` at `a7d5463734b89e8b8ee9ccb59ffff34bcb847501`. The deployed-source commit recorded by the Studio evidence is `5e531a6ea539a941fe3cbaba65c059693e6700b3`; it is retained as historical deployment provenance, not as the current package identity. The current POST_DEPLOY package is `fd956a413bff1be16f5773267ec047243864f2d5`. The delta between the deployed-source commit and this package is documentation-only; contract source, schema, frontend source and tests are unchanged, and the deployed contract source hash is the exact hash above.
...
| C2 | Structural loss: create, lock, put `DROP`, freeze, evaluate | `0xcfe3d2b1cc568140b95bb83f813e64bc10a62ddf0899d9acf0bf9be020765c73` ([authoritative contract index](https://explorer-studio.genlayer.com/api/transactions?address=0xB6D90F9dCbf14A2C638bA62de9ec43e738FCf69d&limit=100&page=1)), `0x241dbe2a6427e142f5140dc565c2c935dedcb2dc701d8ea1bc02a93b16a3668f`, `0x1c9762ccd5aecbe83ef9ea3d465a3b1c7ad81b89be706b39d1dfb8b364b0087a`, `0xd53ed03efd66cb88d2e0f544de97557eafcb3890c065edb218292dbb5de6c4f3`, `0x76ee488cb9c8fb61fc54ba10e5868dc583ba8951828f703fc4aee9bf6dc77b26` | Existing create row is authoritative-index `HTTP 200`/`FINALIZED`, with lifecycle through `ACCEPTED`, five agreeing votes, validator/leader `SUCCESS`, and no pending transactions; readback then reached `DONE`, `LOSS_FOUND`, revision `5`, result `SKIP_DROP` | PASS |
...
- `POST_DEPLOY_TEST` approved package `DSM-LG-POSTDEPLOY-FD956A4` at revision `fd956a413bff1be16f5773267ec047243864f2d5`; GitHub preparation is the next gate after the external target is explicitly confirmed.
